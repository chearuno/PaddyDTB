...
object WebService {
    ...
    public fun sendDificiencyImage(
        context: Context, urlImage: String,
        onCompletion: (status: Boolean, message: String, body: String) -> Unit
    ) {
